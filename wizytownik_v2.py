...
class BusinessContact(BaseContact):
    ...
    def contact(self):
        print(
            f"Wybieram numer {self.telefon_sluzbowy} i dzwonię do {self.imie} {self.nazwisko} w firmie {self.firma}")
...
def create_contacts(rodzaj, ilosc=5):
    ...
    for _ in range(ilosc):
        ...
        if rodzaj == 'base':
            ...
            contact = BusinessContact(stanowisko=stanowisko, firma=firma, telefon_sluzbowy=telefon_sluzbowy,
